...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://reso.wfrmls.com:9999/dialog/authorize';
  options.tokenURL = options.tokenURL || 'https://reso.wfrmls.com:9999/oauth/token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource(config.userInfoURL, accessToken, function (err, body, res) {
